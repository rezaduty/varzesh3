...
class Asia_Cup_Right extends React.Component {
  render() {
    return (
 ...
 <div className="col-left">
                  <div className="widget">
                    <div className="widget-header">جام ملت های آسیا2019 </div>
                      ...
                      <div className="custom-scrool">
                        <div className="leag-table">
                          <table className="graytable">
                            <thead>
                              <tr>
                                <th className="thead theadblue" colSpan={10}>
                                  گروه D
                                </th>
                              </tr>
                            </thead>
